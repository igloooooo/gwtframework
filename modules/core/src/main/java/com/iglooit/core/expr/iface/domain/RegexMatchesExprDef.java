...
public class RegexMatchesExprDef extends ExprDef
{
    public RegexMatchesExprDef()
    {
        super(ExprDefType.REGEX_MATCHES, "Matches");
    }

    @Override
    public Expr instantiate(UUID expressionId)
    {
        return new RegexMatchesExpr(expressionId);
    }
    ...
    {
        return new RegexMatchesExprDefMeta(this);
    }
}
