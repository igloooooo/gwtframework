...
/**
 * This class is identical to TypeConvertingValidatableComboBox
 * except that it does not always return false when validate
 * refer to method "private void init()"
 */
public class ClarityTypeConvertableComboBox<InternalType, DisplayType> implements
    ...
    SimpleComboBox<DisplayType>>
{
    ...
    public ClarityTypeConvertableComboBox(AsyncLoadingList<InternalType> loader,
    ...
    public ClarityTypeConvertableComboBox(List<InternalType> options,
                                          TypeConverter<InternalType, DisplayType> converterToDisplayType)
    {
        super();
        this.converterToDisplayType = converterToDisplayType;
    ...
    private void init()
    {
        ...
        {
            //here is the only difference compared to TypeConvertingValidatableComboBox
//            @Override
...
//            }
    ...
    public HandlerRegistration addValueChangeHandler(final ValueChangeHandler<InternalType> tValueChangeHandler)
    {
        ...
        final HandlerRegistration selectionChangeReg =
            ClarityTypeConvertableComboBox.this.addSelectionHandler(new SelectionHandler<InternalType>()
            {
