...
public final class QueryBuilder
{
     ...
     * Query q = builder.createQuery(entityManager, options, "u");<br>
    ...
    public void appendLikeSkipEmpty(String property, String value)
    {
        ...
        {
            queryStringBuf.append(whereOrAnd());
            queryStringBuf.append(" ").append(property).append(" like ?").append(++parameterNumber);
     ...
     *
     * @param property eg. "u.emailAddress". This would be converted to "u.emailAddress like ".
     * @param value    eg. "Goo" would be converted to "'%Goo%'". Null string is not converted.
     */
    public void appendLikeLenientSkipEmpty(String property, String value)
    {

        if (StringUtil.isEmpty(value))
        {
            appendLikeSkipEmpty(property, value);
        }
        else
        {
            appendLikeSkipEmpty(property, "%" + value);
     ...
     *
     * @param property eg. "u.emailAddress". This would be converted to "lower(u.emailAddress) like ".
     * @param value    eg. "Goo" would be converted to "lower('%goo%')". Null string is not converted.
     */
    public void appendLikeLenientIgnoreCaseSkipEmpty(String property, String value)
    {
        if (StringUtil.isEmpty(value))
        {
            appendLikeSkipEmpty(property, value);
    ...
    public void appendGeneric(String query)
    {
        queryStringBuf.append(whereOrAnd());
        queryStringBuf.append(" ".concat(query).concat(" "));
    }
    ...
    {
        queryStringBuf.append(whereOrAnd());
        queryStringBuf.append(" ").append(property).append(" = ?").append(++parameterNumber);
     ...
     *
     * @param property eg. "u.expiryDate". This would be converted to "u.expiryDate = ".
     * @param value    Any valid object, eg. a Date or a String. If empty (null, empty string, or whitespace string)
     *                 then this operation will be abandoned and the query will not have changed.
     */
     ...
     *
     * @param property eg. "u.statusCode". This would be converted to "lower(u.statusCode) = ".
     * @param value    A string, eg. "ACTIVE". This would be converted to "lower('ACTIVE')". If empty (null, empty
     *                 string, or whitespace string) then this operation will be abandoned and the query will not have
     *                 changed.
     */
        ...
        if (value != null)
        {
            ...
            switch (comparisonOperator)
            {
                ...
                case NE:
                    ...
                    break;
                default:
                    throw new IllegalStateException("comparisonOperator = ".concat(String.valueOf(comparisonOperator)));
            }
     ...
     *
     * @param property      eg. "u.expiryDate".
     * @param fromValue     Can be null, in which case it will be left out of the test. If toValue is also null then no
     *                      test will be generated.
     * @param toValue       Can be null, in which case it will be left out of the test. If fromValue is also null then
    ...
    public void appendBetween(String property, Object fromValue, Object toValue, boolean includeEquals)
    {
        ...
        if ((fromValue != null) || (toValue != null))
        {
            ...
            if (fromValue != null)
            {
                ...
                if (includeEquals)
                {
                    queryStringBuf.append(" ").append(property)
                        .append(" >= ?".concat(String.valueOf(++parameterNumber)));
                }
                else
                {
                    queryStringBuf.append(" ").append(property)
    ...
    private String createOrderByClause(SearchOptions options, String objectPrefix)
    {
        ...
        for (String sortColumnName : options.getSortColumnNames())
        {
            if (!StringUtil.isEmpty(sortColumnName))
            {
                ...
                builder.append(" ").append(objectPrefix).append(".").append(sortColumnName);
                builder.append(options.isSortAscending(index) ? " asc" : " desc");
            }
            index++;
        }
