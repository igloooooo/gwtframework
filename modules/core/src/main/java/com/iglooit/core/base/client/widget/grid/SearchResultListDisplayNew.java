...
public abstract class SearchResultListDisplayNew<MD extends ModelData> extends ClarityGrid<MD>
{
    ...
    public SearchResultListDisplayNew()
    {
    }

    public void configure(int pagingPageSize)
    {
        configure(pagingPageSize, null);
    }

    public void configure(int pagingPageSize, boolean bottomPaging)
    {
        configure(pagingPageSize, null, bottomPaging, null);
    }

    public void configure(int pagingPageSize, boolean bottomPaging,
                                      String initialSortField, OrderBy initialSortDirection)
    {
        configure(pagingPageSize, null, bottomPaging, initialSortField, initialSortDirection, null);
    }

    public void configure(int pagingPageSize, MD filterModelData)
    {
        configure(pagingPageSize, filterModelData, false, null);
    }

    public void configure(int pagingPageSize, MD filterModelData, boolean bottomPaging, List<ColumnConfig>
        columnConfig)
    {
        configure(pagingPageSize, filterModelData, bottomPaging, null, null, columnConfig);
    }

    public void configure(int pagingPageSize, MD filterModelData, boolean bottomPaging,
                                      String initialSortField, OrderBy initialSortDirection,
...
//        grid.setAutoWidth(true);
        // these are defaults, they will change
        //grid.setWidth(500);
