...
public class ValidatableTimeField implements ClarityField<String, ClarityTimeField>
{
    private ClarityTimeField timeField;

    public ValidatableTimeField()
    {
        this.timeField = new ClarityTimeField();
        this.timeField.setAllowBlank(false);
    }

    public ValidatableTimeField(int increment)
    {
        this.timeField = new ClarityTimeField();
        this.timeField.setAllowBlank(false);
        this.timeField.setIncrement(increment);
    }
    ...
    public ClarityTimeField getField()
    {
        return timeField;
    }
    ...
    private void fireValidationChangeEvent()
    {
        if (fireChangeEvents)
        {
            ...
            ValueChangeEvent.fire(ValidatableTimeField.this, value);
        }
    }
}
