...
public class StatusUnclassifiedEvent extends GwtEvent<StatusUnclassifiedEvent.Handler>
{
    ...
    public StatusUnclassifiedEvent(String statusMessage, MessageBoxHtml.MessageType messageType)
    {
        this.statusMessage = statusMessage;
        this.messageType = messageType;
    }

    public StatusUnclassifiedEvent(String title,
                                      String message,
    ...
    {
        void handle(StatusUnclassifiedEvent event);
    }
}
