...
public class ValidatableDoubleSpinnerFieldBinder extends MutableBinder<Double>
{
    ...
    public ValidatableDoubleSpinnerFieldBinder(ValidatableDoubleSpinnerField field,
