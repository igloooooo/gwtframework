...
public class StringValueExprDef extends ExprDef
{
    public StringValueExprDef()
    {
        super(ExprDefType.STRING_VALUE, "String");
    }

    @Override
    public Expr instantiate(UUID expressionId)
    {
        return new StringValueExpr(expressionId);
    }
    ...
    {
        return new StringValueExprDefMeta(this);
    }
}
